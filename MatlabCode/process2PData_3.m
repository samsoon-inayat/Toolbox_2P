...
folderName = 'F:\Sam\Data\AnimalID_xxx\04_27_2016\R1\TSeries\HPC_axons_RSC005';

averageImage = double(imread(makeName('averageImage.tif',folderName)));
figure(1);clf;imagesc(averageImage);
...
interesting = 1:length(indicesOfMeanCalSig);%[1 2 8 13 7 11];
figure(1);clf;
