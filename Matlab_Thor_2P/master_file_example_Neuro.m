...
ops0.temp_tiff              = makeName('temp.tif',mainFolder); % copies each remote tiff locally first, into this file
...
ops0.imageRate              = 15;   % imaging rate (cumulative over planes!). Approximate, for initialization of deconvolution kernel.
