...
legs = {'Context 1','Context 2','Context 3','Context 4','Context 5','Context 6','Context 7',[60 5 30 3]};
...
save_pdf(hf,mData.pdf_folder,'figure_percent_place_cells_vs_centers_16.pdf',600);
return;
end
...
legs{ii+1} = [35 5 160 10];putLegend(gca,legs,'colors',colors,'sigR',{sigR,'ancovas',sigColor,9}); text(5,160,'Slope','FontWeight','Bold');

changePosition(gca,[-0.03 0.09 0.09 -0.06]);
save_pdf(hf,mData.pdf_folder,'figure_scatter_centers_widths_16.pdf',600);
return;
end
...
changePosition(gca,[-0.03 0.09 0.09 -0.06]);
save_pdf(hf,mData.pdf_folder,'figure_scatter_centers_zMI_16.pdf',600);
return;
end
