...
%     axes(ff.h_axes(1));
    ...
    ex = (10*cs)+0.5;
    for ii = 1:cs
        plot([(10.5+((ii-1)*10)) (10.5+((ii-1)*10))],[0 ex],'w','linewidth',0.1); 
        plot([0 ex],[(10.5+((ii-1)*10)) (10.5+((ii-1)*10))],'w','linewidth',0.1); 
    end
%     for ii = [2 6 9 12]   
...
%     end
    ...
    xtickvals = 5:10:(cs*10);%[5 15 25 60 100 115 125];
