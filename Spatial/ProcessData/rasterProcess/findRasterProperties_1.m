function Rs = findRasterProperties_1 (thispFolder,contextNumber,stimMarker,Rs,thisRasterType,trials,ow)
...
Rs_functions = allContexts.rasterFunctions([4 5 6]);
Rs_varNames = allContexts.varNames([1 2 3]);
