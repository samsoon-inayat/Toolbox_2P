function out =  getFits_myGaussFit_2(thispFolder,contextNumber,stimMarker,Rs,thisRasterType,trials,ow)

fileName = makeName(sprintf('gauss_fit_on_means_2_%d_%s_%s.mat',contextNumber,stimMarker,thisRasterType),thispFolder);
