    ...
    for ii = 1:size(Rs,1)
        for cc = 1:size(Rs,2)
            ...
            if strcmp(R.marker_name,'light22T') || strcmp(R.marker_name,'air55T') || strcmp(R.marker_name,'airIT') || ...
                    ...
                    || strcmp(R.marker_name,'airOnsets22P') || strcmp(R.marker_name,'airOnsets11T') || strcmp(R.marker_name,'airOffsets11T') || strcmp(R.marker_name,'light11T') || strcmp(R.marker_name,'beltT')
