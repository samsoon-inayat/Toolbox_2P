function out = fractalDim_2(thispFolder,contextNumber,stimMarker,Rs,thisRasterType,trials,ow)


fileName = makeName(sprintf('factal_dim_2_%d_%s_%s.mat',contextNumber,stimMarker,thisRasterType),thispFolder);
