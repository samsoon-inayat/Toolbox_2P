...
for pp = 1:length(ei.plane)
    ...
    ind = strfind(thispFolder,'\Matlab11');
    thispFolder1 = thispFolder(1:ind);
    ind = strfind(thispFolder,'Matlab11\');
    thispFolder2 = thispFolder((ind+length('Matlab11')):end);
    thispFolder = [thispFolder1 'Matlab' thispFolder2];
