...
dataTA = make_between_table({meanDistD},dvn);
ra = RMA(dataTA,within,{0.05,{'hsd'}});
ra.ranova
clc
...
MY = 1.5; ysp = 0.1; mY = -0.7; ystf = 0.1; ysigf = 0.31;titletxt = ''; ylabeltxt = {'PDF'}; % for all cells (vals) MY = 80
...
[hbs,xdata] = view_results_rmanova(ff.h_axes(1,1),ra,{'Rs_f','hsd',0.05},xs_gaps,tcolors,[mY MY ysp ystf ysigf],mData);
xticklabels = {'Linear','Sigmoid','Gaussian'};set(gca,'xtick',xdata,'xticklabels',xticklabels); xtickangle(30);
ylabel('R-Sq'); 
