...
config.pySuite2p = 'C:\Users\samsoon.inayat\AppData\Local\Continuum\anaconda3\envs\suite2p';
config.suite2p_wrapper = 'T:\GitHub\Toolbox_2P\Suite2P_Wrapper';
config.dFolder{1} = '\\mohajerani-nas.uleth.ca\storage\homes\samsoon.inayat\Data';
config.dFolder{2} = '\\mohajerani-nas.uleth.ca\storage2\homes\samsoon.inayat\Data';
config.dFolder{3} = '\\mohajerani-nas.uleth.ca\storage\homes\brendan.mcallister\2P\Data';
