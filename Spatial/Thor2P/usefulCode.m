...
framesPerSet = 500;
setsOfFrames = floor(expInfo.totalFrames/framesPerSet); % find how many sets of frames to be processed  with par for
startOfFramesSet = 1:framesPerSet:expInfo.totalFrames;
endOfFramesSet = (1:framesPerSet:expInfo.totalFrames)-1;
endOfFramesSet(1) = []; endOfFramesSet(end+1) = expInfo.totalFrames;
