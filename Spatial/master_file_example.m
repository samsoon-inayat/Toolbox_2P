...
ops0.RootStorage            = 'S:/Tif_Data'; % Suite2P assumes a folder structure, check out README file
ops0.temp_tiff              = 'S:/temp.tif'; % copies each remote tiff locally first, into this file
ops0.RegFileRoot            = 'S:/Registered_Data';  % location for binary file
ops0.DeleteBin              = 1; % set to 1 for batch processing on a limited hard drive
ops0.ResultsSavePath        = 'S:/Results'; % a folder structure is created inside
ops0.RegFileTiffLocation    = 'S:/Registered_Data'; %'D:/DATA/'; % leave empty to NOT save registered tiffs (slow)
