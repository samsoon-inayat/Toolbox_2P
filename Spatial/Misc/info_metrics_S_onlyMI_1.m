function [ShannonMI,ShannonMI_Zsh,FRbin] = info_metrics_S_onlyMI( FR, stimulus, nbinFRSH, occupSK, nshuffles)
...
ShannonMI = MutualInformation(stimulus,FRbin);
ShannonMI_Zsh = NaN;
if nshuffles == 0
    return;
end
...
%         output.SkaggsSpike_shuffle(s) = shuffleoutput.SkaggsSpike;
    ...
    ShannonMI_Zsh=(output.ShannonMI-mu)/si;
