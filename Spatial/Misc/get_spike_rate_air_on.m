...
%     inds_rest = find(speed < 0.5);
    ...
    air_onsets = ei.b.air_puff_r(11:40);
...
%     inds_motion = find(speed > 0);
    ...
    for aoii = 1:length(air_onsets)
        inds_motion2 = [inds_motion2 intersect(inds_motion,air_onsets(aoii):air_offsets(aoii))];
        inds_rest2 = [inds_rest2 intersect(inds_rest,air_onsets(aoii):air_offsets(aoii))];
    end
