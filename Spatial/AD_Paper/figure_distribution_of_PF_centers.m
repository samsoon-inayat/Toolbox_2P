...
% writetable(dataT,fullfile(mData.pdf_folder,'PFs_centers.xls'));
%%
...
put_axes_labels(gca,{[],[0 0 0]},{{'Place Field Center','Location (cm)'},[0 0 0]});

save_pdf(hf,mData.pdf_folder,'PF_centers_bar_graph_all_cells.pdf',600);
...
save_pdf(hf,mData.pdf_folder,'PF_centers_bar_graph_all_cells_pooled.pdf',600);