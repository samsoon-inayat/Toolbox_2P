...
for rr = 1:size(RsC,1)
    for cc = 1:size(RsC,2)
        R = RsC{rr,cc};
        zMIsC{rr,cc} = R.info_metrics.ShannonMI_Zsh(R.resp.vals)';
        R = RsA{rr,cc};
        zMIsA{rr,cc} = R.info_metrics.ShannonMI_Zsh(R.resp.vals)';
    end
end
n = 0;
%%
...
% writetable(dataT,fullfile(mData.pdf_folder,'zMI_place_cells.xls'));
%%
...
set(gca,'xlim',[0.25 9.75],'ylim',[0 6.5],'FontSize',6,'FontWeight','Bold','TickDir','out','xcolor','k','ycolor','k');
...
save_pdf(hf,mData.pdf_folder,'zMIs_bar_graph_place_cells.pdf',600);
...
set(gca,'xlim',[0.25 4.75],'ylim',[0 6.5],'FontSize',6,'FontWeight','Bold','TickDir','out','xcolor','k','ycolor','k');
xticks = xdata; xticklabels = {'C1','C2','C3','C4'}; xticklabels = repmat(xticklabels,1,2);
set(gca,'xtick',xticks,'xticklabels',xticklabels);
...
save_pdf(hf,mData.pdf_folder,'zMIs_bar_graph_place_cells_pooled.pdf',600);