...
cd(currentDir);
% addpath(scriptPath);
temp = fullfile(currentDir,'MatlabCode','Common');addpath(temp);
temp = fullfile(mainDir,'Downloaded','append_pdfs');addpath(temp);
temp = fullfile(currentDir,'MatlabCode','Thor2P');addpath(temp);
temp = fullfile(currentDir,'MatlabCode','FigureFunctions');addpath(temp);
