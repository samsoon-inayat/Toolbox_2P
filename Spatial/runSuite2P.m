function runSuite2P(f,animal_id,exp_date,brain_location,dbii,ob,prebidishift)
...
for iii = 1:length(dbii)
    ei{iii} = getData(f,animal_id,exp_date,dbii(iii),'behavior',1,'twoP',0,'brain_location',brain_location,'overwrite_behavior',ob);
