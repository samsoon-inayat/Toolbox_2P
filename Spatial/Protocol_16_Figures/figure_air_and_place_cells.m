function figure_air_and_place_cells(fn,allRs,ccs)
...
legs = {'Context 1','Context 2','Context 3',[11 0.25 1.2 0.1]};
...
text(1,1.33,'Air-Puff Responsive and Place Cells','FontSize',mData.axes_font_size,'FontWeight','Bold');
save_pdf(hf,mData.pdf_folder,'Perc Of air and Place Cells_16',600);
return;
end
...
plotBarsWithSigLines(sigR.means,sigR.sems,sigR.combs,[hs ps],'colors',{'r','b','r','b'},'sigColor',sigColor,...
    'maxY',25,'ySpacing',0.1,'sigTestName','t-test','sigLineWidth',0.25,'BaseValue',0.001,...
...
save_pdf(hf,mData.pdf_folder,'Perc Of air Cells_16',600);
return;
end
