...
text(1,0.6,'Light Responsive and Place Cells','FontSize',mData.axes_font_size,'FontWeight','Bold');
save_pdf(hf,mData.pdf_folder,'Perc Of light and Place Cells_16',600);
return;
end
...
plotBarsWithSigLines(sigR.means,sigR.sems,sigR.combs,[hs ps],'colors',{'r','b','r','b'},'sigColor',sigColor,...
    'maxY',17,'ySpacing',0.1,'sigTestName','t-test','sigLineWidth',0.25,'BaseValue',0.001,...
...
save_pdf(hf,mData.pdf_folder,'Perc Of light Cells_16',600);
return;
end
