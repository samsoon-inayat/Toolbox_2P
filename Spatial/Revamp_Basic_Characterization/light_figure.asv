...
%     set(gca,'XTick',[1.25 2 2.85],'XTickLabels',xticklabels,'YTick',[1.25 2 2.85],'YTickLabels',fliplr(xticklabels));
%     set(gca,'Ydir','Normal','linewidth',0.5,'FontSize',6,'FontWeight','Bold');
