...
while 1
    ...
    selContexts = [1 4 6 2 7 2 7 3 4 5 3 4 5 0 0];
    rasterNames = {'light22T','light22T','light22T','airOnsets22T','airOnsets22T','airOffsets22T','airOffsets22T','airOnsets22T','airOnsets22T','airOnsets22T',...
...
while 1
    ...
    [xdata,mVar,semVar,combs,p,h,colors,xlabels,extras] = get_vals_for_bar_graph_RMA(mData,ra,{'Cond','hsd'},[1 1 1]);
    xdata = make_xdata([3 2 2 3 3 2],[1 1.5]);
    h(h==1) = 0;
...
while 1
    ntrials = 50;
    sic = {[Lb Lbs];ArL_L;[Ab_On Abs_On];[Ab_Off Abs_Off];[Ar_On ArL_On Ars_On];[Ar_Off ArL_Off Ars_Off M_On M_Off]};
    for ii = 1:length(sic)
        end
    props1 = get_props_Rs(o.Rs(:,si),[50]);
%     props1 = get_props_Rs(o.Rs(:,si),[40,70]);
