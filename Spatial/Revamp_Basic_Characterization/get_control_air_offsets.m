...
for pp = 1:numplanes
    ...
    for ci = [2 3 4 5 7]
        ...
        air_offsets = context3.markers.airOffsets22_onsets + round(1e6 * 2/tei.b.si);
        if ismember(ci,[2 7])
        ...
        markersOn = tonsets;
        markersOff = toffsets;
        binWidths = [tplane.contexts(4).rasters.light22T.bin_width tplane.contexts(4).rasters.airD.bin_width];
        binwidths = binWidths;
        ...
        contextMC.rasters.airOffsets22_C = rastersMC;
        ...
        context3.rasters.airOffsets22_C = rasters;
