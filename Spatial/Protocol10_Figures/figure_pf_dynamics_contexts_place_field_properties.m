...
pcs5 = distD; distD = [];
selContexts = [3 4];
selCells = selectCells10(selAnimals,'Common34');
...
save_pdf(hf,mData.pdf_folder,'figure_percent_place_cells_vs_centers_contexts.pdf',600);
return;
end
...
save_pdf(hf,mData.pdf_folder,'figure_scatter_centers_widths_contexts.pdf',600);
return;
end
...
save_pdf(hf,mData.pdf_folder,'figure_scatter_centers_zMI_contexts.pdf',600);
return;
end
