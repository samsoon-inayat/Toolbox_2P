...
switch ci
    case 1
        ...
        MY = 0.12; ysp = 0.01; mY = 0; titletxt = 'Temporal Correlation'; ylabeltxt = {'A.U.'};
    case 2
...
ra.ranova
% just cond
ff = makeFigureRowsCols(108,[10 5 2.25 1.25],'RowsCols',[1 1],'spaceRowsCols',[0.01 -0.02],'rightUpShifts',[0.07 0.26],'widthHeightAdjustment',[10 -410]);
...
%%
%%%% Correlations across conditions
ff = makeFigureRowsCols(108,[10 7 2.25 1.25],'RowsCols',[1 1],'spaceRowsCols',[0.01 -0.02],'rightUpShifts',[0.07 0.26],'widthHeightAdjustment',[10 -410]);
