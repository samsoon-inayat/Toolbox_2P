...
switch ci
    case 1
        ...
        MY = 0.25; ysp = 0.05; mY = 0; titletxt = 'Spatial Corr.'; ylabeltxt = {'A.U.'};
    case 2
        var_C = arrayfun(@(x) mean(x{1}),selC.adj_PV_corr_diag);var_A = arrayfun(@(x) mean(x{1}),selA.adj_PV_corr_diag);
        MY = 0.3; ysp = 0.05; mY = 0; titletxt = 'PV Corr.'; ylabeltxt = {'A.U.'};
    case 3
...
%%
%%%% just cond
ff = makeFigureRowsCols(108,[10 3 2.25 1.25],'RowsCols',[1 1],'spaceRowsCols',[0.01 -0.02],'rightUpShifts',[0.07 0.26],'widthHeightAdjustment',[10 -410]);
