...
switch varT
    case 1 % responsive cells 
        MY = 12; ysp = 2; mY = 0; titletxt = 'Responsivity'; ylabeltxt = {'Percent of Cells'};
    case 2
...
stp = 0.3;magfac; widths = ([0.4 0.5 1.3 1.3 0.5 0.5 0.5]+0.18)*magfac; gap = 0.1*magfac;
adjust_axes(ff,[mY MY],stp,widths,gap,{''});
...
ht = set_axes_top_text_no_line(gcf,gca,titletxt,[0 -0.051 0.3 0]); set(ht,'FontWeight','Bold');
...
stp = 0.3;magfac; widths = ([4.1 0.4 0.5 1.3 1.3 0.5 0.5 0.5]+0.18)*magfac; gap = 0.1*magfac;
adjust_axes(ff,[mY MY],stp,widths,gap,{''});
