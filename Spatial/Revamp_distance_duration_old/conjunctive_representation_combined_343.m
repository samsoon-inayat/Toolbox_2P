function conjunctive_representation_combined_343
...
while 1
    ...
    selContexts = [8 8 8 8];
    rasterNames = {'airD','airID','airT','airIT'};
    rasterNamesTxt = {'AC-t-D','AC-i-D','AC-t-T','AC-i-T'};
    ...
    AC_t_D = 1; AC_i_D = 2; AC_t_T = 3; AC_i_T = 4;
    break
end
toc
n = 0;
