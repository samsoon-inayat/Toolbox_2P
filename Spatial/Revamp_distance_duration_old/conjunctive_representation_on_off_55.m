...
while 1
    ...
    rasterNames = {'airOnsets55T','airOnsets55T','airOnsets55T',...
                    'airOffsets55T','airOffsets55T','airOffsets55T'};
    rasterNamesTxt = {'3-AOn','4-AOn','5-AOn','3-AOff','4-AOff','5-AOff'};
    ...
    Ar_On = 1; ArL_On = 2; Ars_On = 3; Ar_Off = 4; ArL_Off = 5; Ars_Off = 6;
    break
end
toc
n = 0;
...
while 1
   ...
   Rs = o.Rs(:,si);
    props = get_props_Rs(Rs,30);
    resp = find(props.vals{an,cn});
    
%    plotRasters_simplest(Rs{an,cn},resp);
