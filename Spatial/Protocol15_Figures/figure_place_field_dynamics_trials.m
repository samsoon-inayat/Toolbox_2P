...
save_pdf(ff.hf,mData.pdf_folder,sprintf('figure_pf_dynamics_trials_%d_15',context),600);
return;
end
n = 0;
%%
...
[ha,hb,hca,sigR] = plotDistributions(distD,'colors',colors,'maxY',80,'cumPos',[0.55 0.4 0.3 0.3],'min',-35,'incr',5,'max',40);
legs = {'C 1','C 2','C 3',[-10 3 80 8]};
...
fileName = sprintf('figure_pf_dynamics_peak_shifts_%d_%d_15.pdf',peakpositions(1),peakpositions(2));
